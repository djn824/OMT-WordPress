...
/* 	#phone-bg{ */
	...
	[dir="rtl"] #pattern-group {
		direction: rtl; /* Keep the grid layout LTR */
	}
	...
	[dir="rtl"] #pattern-group .col-xl-10 {
		direction: rtl; /* But keep the content RTL */
	}
...
<!-- 						<img class="img-fluid pt-1 skip-lazy" src="<?=get_stylesheet_directory_uri();?>/assets/images/unlimited1.png" alt="" id="unlimited"> -->
			...
			<div>
				...
				<div class="dis-flex align-items-center justify-content-between" id="custom-title-group">
					...
					<img class="img-fluid all-options skip-lazy pattern-cursor" src="<?=get_stylesheet_directory_uri();?>/assets/images/AllOptions.svg" id="all-options" alt="">
				</div>
					<div class="row" id="pattern-group">
						<div class="col-4 col-sm-3 col-md-2 col-lg-3 col-xl-2 d-flex-column pattern-item text-left" id="continuous">
							<img class="pattern-item img-fluid skip-lazy pattern-cursor" src="<?=get_stylesheet_directory_uri();?>/assets/images/Continuous2.svg" alt="">
						...
						<div class="col-4 col-sm-3 col-md-2 col-lg-3 col-xl-2 align-items-center" id="start-stop">
							<img class="pattern-item img-fluid skip-lazy pattern-cursor" src="<?=get_stylesheet_directory_uri();?>/assets/images/Start-Stop1.svg" alt="">
						...
						<div class="col-8 col-sm-9 col-md-10 col-lg-9 col-xl-10" id="custom-slider-group">
							...
							<div class="w-full custom-slider slider-container">
								<input type="range" min="0.2" max="10" value="3" step="0.1" class="slider" id="vibration-range">
						...
						<div class="col-4 col-sm-3 col-md-2 col-lg-3 col-xl-2" id="custom">
							<div>
								<img class="pattern-item img-fluid skip-lazy pattern-cursor" src="<?=get_stylesheet_directory_uri();?>/assets/images/Custom1.svg" alt="">
								<div class="style-btn-label px-2 pattern-cursor" id="custom-label">&nbsp;<?php the_field('custom_label');?></div>
							</div>
						</div>
					</div>
			</div>
		...
		<div class="col-6 col-lg-5 col-xl-5 col-xxl-5 text-center align-items-center image-container"  id="phone-bg">
			<div class="justify-content-center d-flex">
				<img class="img-fluid skip-lazy" src="<?=get_stylesheet_directory_uri();?>/assets/images/StartPhone.svg" alt="" id="stop-phone">
			</div>
			<div class="phone-btn-style flex-column justify-content-center">
				<center><img class="img-fluid skip-lazy" src="<?=get_stylesheet_directory_uri();?>/assets/images/Play.svg" alt="" id="start-btn"></center>
				<p class="phone-text d-flex justify-content-center" id="phone-label"><?php the_field('start_phone_label');?></p>
			</div>
		</div>
		<div class="col-12 col-lg-5 col-xl-5 col-xxl-5 text-center align-items-center image-container" id="testing-phone">
			<div class="justify-content-center d-flex">
<!-- 				<div class="vector d-flex">
				...
				<img class="img-fluid skip-lazy" src="<?=get_stylesheet_directory_uri();?>/assets/images/vibrationPhone.gif" alt="" id="vibration-phone">
<!-- 				<div class="vector d-flex">
			...
			<div class="phone-btn-style flex-column justify-content-center">
				<center><img class="img-fluid skip-lazy" src="<?=get_stylesheet_directory_uri();?>/assets/images/Stop.svg" alt="" id="stop-btn"></center>
				<p class="phone-text d-flex justify-content-center" id="phone-label"><?php the_field('testing_phone_label');?></p>
			</div>
		</div>
	</div>
	<br/>
...
<script>
	(function() {
		...
		let isRTL = url.toLowerCase().includes("/ar") || document.dir === 'rtl' || document.documentElement.dir === 'rtl';
		let isTesting = false;
		let stopTimer;
		...
		a.main = function(){
			function onStop() {
// 				const v1 = navigator.vibrate(0);
// 				const v2 = navigator.vibrate([]);
				navigator.vibrate(1);
...
// 					}, 1000);
				...
				a.continuousBtn.addEventListener("click", function() {
					onStop();
					a.continuousImg.src = "https://03a897595e3ab43aefc8b.admin.hardypress.com/wp-content/themes/onlinemictest_child-2/assets/images/Continuous2.svg";
					a.startStopImg.src = "https://03a897595e3ab43aefc8b.admin.hardypress.com/wp-content/themes/onlinemictest_child-2/assets/images/Start-Stop1.svg";
					
					vibrationPattern = "continuous";
				});
				
				a.startStopBtn.addEventListener("click", function() {
					a.continuousImg.src = "https://03a897595e3ab43aefc8b.admin.hardypress.com/wp-content/themes/onlinemictest_child-2/assets/images/Continuous1.svg";
					a.startStopImg.src = "https://03a897595e3ab43aefc8b.admin.hardypress.com/wp-content/themes/onlinemictest_child-2/assets/images/Start-Stop2.svg";
					onStop();
				...
				a.customBtn.addEventListener("click", function() {
					...
					a.customImg.src = "https://03a897595e3ab43aefc8b.admin.hardypress.com/wp-content/themes/onlinemictest_child-2/assets/images/Custom2.svg";
					a.startStopImg.src = "https://03a897595e3ab43aefc8b.admin.hardypress.com/wp-content/themes/onlinemictest_child-2/assets/images/Start-Stop2.svg";
				...
				a.allOptionsBtn.addEventListener("click", function() {
					...
					a.customImg.src = "https://03a897595e3ab43aefc8b.admin.hardypress.com/wp-content/themes/onlinemictest_child-2/assets/images/Custom1.svg";
					a.continuousImg.src = "https://03a897595e3ab43aefc8b.admin.hardypress.com/wp-content/themes/onlinemictest_child-2/assets/images/Continuous2.svg";
					a.startStopImg.src = "https://03a897595e3ab43aefc8b.admin.hardypress.com/wp-content/themes/onlinemictest_child-2/assets/images/Start-Stop1.svg";
				...
				function updateTimeRange() {
					...
					let bgGradient = `linear-gradient(to ${direction}, #F3631D 0%, #F3631D ${percent}%, #F3631D80 ${percent}%, #F3631D80 100%)`;
				...
				function onMouseMove(e) {
					...
					const value = (percent * (a.timeRange.max - slider.min) / 100) + Number(a.timeRange.min);
				...
				function updateVibrationRange() {
					...
					a.vibrationRangeThumb.style.left = `calc(${thumbPercent}% + (${8 - thumbPercent * 0.16}px))`;
...
// 				});
				...
				function onMouseMoveVib(e) {
					...
					const value = (percent * (a.vibrationRange.max - slider.min) / 100) + Number(a.vibrationRange.min);
...
// 				});
				...
				function onMouseMoveStp(e) {
					...
					const value = (percent * (a.stopRange.max - slider.min) / 100) + Number(a.stopRange.min);
