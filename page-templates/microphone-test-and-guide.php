...
/*
 * Template Name: Mic test and guide
*/
get_header();
?>
                            ...
                            <div class="top-social_block">
                                <div class="swp_social_panel swp_flat_fresh swp_default_full_color swp_individual_full_color swp_other_full_color scale-100 scale- swp_one" data-position="none" data-float="none" data-float-mobile="none" data-count="0" data-floatcolor="#ffffff">
                                    <div class="nc_tweetContainer swp_twitter" data-network="twitter">
                                        <a rel="nofollow" target="_blank" href="https://twitter.com/intent/tweet?text=Microphone+Test&amp;url=<?php echo get_site_url();?>" data-link="https://twitter.com/intent/tweet?text=Microphone+Test&amp;url=<?php echo get_site_url();?>" class="nc_tweet">
                                    ...
                                    <div class="nc_tweetContainer swp_facebook" data-network="facebook">
                                        <a rel="nofollow" target="_blank" href="http://www.facebook.com/share.php?u=<?php echo get_site_url();?>" data-link="http://www.facebook.com/share.php?u=<?php echo get_site_url();?>" class="nc_tweet">
                                            <span class="iconFiller">
                                                <span class="spaceManWilly">
