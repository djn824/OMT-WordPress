<?php
/* Template Name:Tone Generator*/
get_header();?>
<style type="text/css"><?php //the_field('css');?></style>
<body <?php body_class( 'mouse-test' ); ?>>
			...
			<div class="wrap">
				...
				<article>
					...
					<div class="cnt content">
							...
							<div class="top-social_block">
								...
								<div class="swp_social_panel swp_flat_fresh swp_default_full_color swp_individual_full_color swp_other_full_color scale-100 scale- swp_one" data-position="none" data-float="none" data-float-mobile="none" data-count="0" data-floatcolor="#ffffff">
									...
									<div class="nc_tweetContainer swp_twitter" data-network="twitter">
										...
										<a rel="nofollow" target="_blank" href="https://twitter.com/intent/tweet?text=Mouse+Test&url=<?php echo get_site_url();?>/mouse-test/" data-link="https://twitter.com/intent/tweet?text=Mouse+Test&url=<?php echo get_site_url();?>/mouse-test/" class="nc_tweet"><span class="swp_count swp_hide"><span class="iconFiller"><span class="spaceManWilly"><i class="sw swp_twitter_icon"></i><span class="swp_share">Tweet</span></span></span></span></a>

									</div>

									<div class="nc_tweetContainer swp_facebook" data-network="facebook">

										<a rel="nofollow" target="_blank" href="http://www.facebook.com/share.php?u=<?php echo get_site_url();?>/mouse-test/" data-link="http://www.facebook.com/share.php?u=<?php echo get_site_url();?>/mouse-test/" class="nc_tweet"><span class="iconFiller"><span class="spaceManWilly"><i class="sw swp_facebook_icon"></i><span class="swp_share">Share</span></span></span></a>
						...
						<div class="content-area webcam-test">
                            ...
                            <div id="pitch-detector">
                                <div id="pitch-wheel">
                                    ...
                                    <svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd"
                                        ...
                                        <text x="506.058" y="65.588"
                                              font-family="'OpenSans-CondensedBold','Open Sans Condensed',sans-serif"
                                              font-weight="700" font-stretch="condensed" font-size="48" fill="#436f8e"
                                              transform="rotate(-45 536.647 482.786) scale(.96289)">A
                                        </text>
                                ...
                                <div id="pitch-freq">
                                    <div id="pitch-audio-start">
                                        ...
                                        <button id="audio-start" class="audio-button"><img src="<?= get_template_directory_uri();?>/assets/image/pitch-detector/play.svg"
                                                                                           alt="Start Audio"/></button>
                                ...
                                <script src="<?= get_template_directory_uri();?>/assets/js/pitch-detector/index.js"></script>
                            </div>
...
<!--									<div class="width-6 wid-xs-20">-->
<!--                                        <img class="tve_image" alt="" style="width: 64px;" src="--><?php //the_field('red_mouse_icon');?><!--" data-attachment-id="8509" width="64" height="64">-->
<!--									</div>-->
<!--									<div class="width-94 wid-xs-80">-->
