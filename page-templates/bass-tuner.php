            ...
            <article>
                ...
                <div class="cnt content">
                    ...
                    <div class="content-area webcam-test">
                        ...
                        <div id="bass-tuner" class="dis-flex xs-dis-block">
                            <div class="width-50 wid-xxs-100 dis-flex">
                                <div id="bass-tuner-img">
                ...
                <g transform="matrix(65.2646,0,0,65.2646,476.558,337.491)">
                    <g id="E_5">
                        <g>
                            ...
                            <link rel="stylesheet"
                                  href="<?= get_template_directory_uri(); ?>/assets/css/bass-tuners/style.css">
                            <script src="<?= get_template_directory_uri(); ?>/assets/js/pitch-detector/vendor/aubiojs/build/aubio.js"></script>
                            <script src="<?= get_template_directory_uri(); ?>/assets/js/bass-tuners/index.js"></script>
                            <audio id="tuned-jingle">
                                <source src="<?= get_template_directory_uri(); ?>/assets/sounds/bass-tuners/light-audioblocks-bright-kalimba-note.mp3"
                                        type="audio/mpeg">
                                <source src="<?= get_template_directory_uri(); ?>/assets/sounds/bass-tuners/audioblocks-bright-kalimba-note-notification-5_BYEl8lfI0w8.wav"
                                        type="audio/wav">
                            </audio>
                        </div>
                        ...
                        <div class="wid-sm-100 wid-xs-100">
                            ...
                            <!--                             Your Privacy Is Important To Us           <img class="tve_image" alt="" style="width: 64px;" src="--><?php //the_field('red_mouse_icon');?><!--" data-attachment-id="8509" width="64" height="64">-->
                            <!--                                    </div>-->
