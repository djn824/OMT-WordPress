<?php /*Template Name:Webcam test and guide*/

get_header(); ?>

    <style><?php //the_field('stylesheet');?></style>

<!--    <body class="webcam-test">-->
                            ...
                            <div class="swp_social_panel swp_flat_fresh swp_default_full_color swp_individual_full_color swp_other_full_color scale-100 scale- swp_one"
                                ...
                                <div class="nc_tweetContainer swp_twitter" data-network="twitter">
                                    <a rel="nofollow" target="_blank"
                                       href="https://twitter.com/intent/tweet?text=Webcam+Test&url=<?php echo get_site_url(); ?>/webcam-test/"
                                       data-link="https://twitter.com/intent/tweet?text=Webcam+Test&url=<?php echo get_site_url(); ?>/webcam-test/"
                                       class="nc_tweet"><span class="swp_count swp_hide"><span class="iconFiller"><span
                                                        class="spaceManWilly"><i class="sw swp_twitter_icon"></i><span
                                                            class="swp_share">Tweet</span></span></span></span>
                                    </a>
                                </div>

                                <div class="nc_tweetContainer swp_facebook" data-network="facebook">
                                    <a rel="nofollow" target="_blank"
                                       href="http://www.facebook.com/share.php?u=https:<?php echo get_site_url(); ?>/webcam-test/"
                                       data-link="http://www.facebook.com/share.php?u=<?php echo get_site_url(); ?>/webcam-test/"
